...
class TrackballControls extends EventDispatcher
{
	...
	public wheelSpeed              : number     = 0.005;
	...
	private STATE                   : TrackballControlsState = new TrackballControlsState();//Object = { NONE: -1, ROTATE: 0, ZOOM: 1, PAN: 2, TOUCH_ROTATE: 3, TOUCH_ZOOM: 4, TOUCH_PAN: 5 };
	private screen                  : TrackballControlsScreen = new TrackballControlsScreen();
	...
	public dispose() : void
	{
		...
		this.domElement.removeEventListener( 'DOMMouseScroll', this.DOMMouseScrollFnc , false ); // firefox
