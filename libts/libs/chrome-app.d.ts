...
declare module chrome.usb {
	...
	export function getDevices( options ? : Object , callback ? : (listDevices: Object ) => void)
}

declare module chrome.serial {

	export function getDevices( callback ? : (ports: Object ) => void);
	export function connect( selectedPort : string , callback ? : (ports: Object ) => void);
	export function connect( selectedPort : string , options: Object , callback ? : (ports: Object ) => void);
	export function disconnect( connectionid : number , callback ? : (success: boolean ) => void);
	var onReceive: any;
	var onReceiveError: any;

}

declare module chrome.system.storage{

	export function getInfo ( callback ? : (result: Array<StorageUnitInfo>) => void)
...
declare module chrome.fileSystem{
	...
	export function chooseEntry(options : Object , callback ? : (entry: Array<Object> ) => void );
	export function chooseEntry(options : Object , callback ? : (entry: Object ) => void );

	export function retainEntry( entry : any );
	export function restoreEntry( entry : any , callback ? : (entry: Object ) => void );
